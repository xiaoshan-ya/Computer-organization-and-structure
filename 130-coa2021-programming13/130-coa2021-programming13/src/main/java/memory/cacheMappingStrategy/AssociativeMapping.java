...
public class AssociativeMapping extends MappingStrategy {  // 全相联映射
    ...
    public int writeCache(int blockNO) {
        ...
        return this.replacementStrategy.writeCache( 0, CACHE_LINE-1, addrTag, Memory.getMemory().read(t.intToBinary(String.valueOf(Cache.LINE_SIZE_B * blockNO)), Cache.LINE_SIZE_B) );
    }
}
